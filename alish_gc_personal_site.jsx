...
const CONFIG = {
  site: {
    title: "Alish GC",
    tagline: "Student • Tech learner • Investor (learning)",
    description:
      "I'm Alish, an 18 y/o management student in Nepal exploring BIT, tech, and content. I share what I learn about study, tools, and simple finance.",
    primaryColor: "#0ea5e9", // sky-500
    darkColor: "#0b1220",
  },
  hero: {
    name: "Alish GC",
    role: "Student & Aspiring BIT Grad",
        ...
        <div className="grid md:grid-cols-3 gap-10 items-start">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/50 rounded-3xl p-6 ring-1 ring-slate-200 dark:ring-slate-800">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li>🎓 NEB Grade 12 (Hotel Management course)</li>
              <li>🎯 Goal: Study BIT at TU / NZ</li>
